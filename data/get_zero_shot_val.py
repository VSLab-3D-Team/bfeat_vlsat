...
if __name__ == '__main__':
    ...
    with open('/media/michael/ssd1/SceneGraph/3DSSG/3DSSG_subset/classes.txt') as f:
        obj_names = f.read().splitlines()
    with open('/media/michael/ssd1/SceneGraph/3DSSG/3DSSG_subset/relationships.txt') as f:
