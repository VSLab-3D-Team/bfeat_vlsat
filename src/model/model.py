...
class MMGNet():
    ...
    def validation(self, debug_mode = False):
        ...
        sgcls_recall_w_list, predcls_recall_w_list, sgcls_mean_recall_w_list, predcls_mean_recall_w_list, sgcls_recall_wo_list, predcls_recall_wo_list = [], [], [], [], [], []
        ...
        for i, items in enumerate(val_loader, 0):
            ...
            with torch.no_grad():
                top_k_obj, top_k_obj_2d, top_k_rel, top_k_rel_2d, tok_k_triplet, top_k_2d_triplet, cls_matrix, sub_scores, obj_scores, rel_scores, sgcls_recall_w, predcls_recall_w, sgcls_recall_wo, predcls_recall_wo, sgcls_mean_recall_w, predcls_mean_recall_w \
