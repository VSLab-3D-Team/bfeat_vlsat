...
def save_gt(i, gt_class, gt_rel_cls, edge_indices, visualization_path="/media/michael/ssd1/SceneGraph/bfeat_neurips_viz"):
...
def save_prediction(i, cls, rel_cls, visualization_path="/media/michael/ssd1/SceneGraph/bfeat_neurips_viz"):
    save_gt_path=os.path.join(visualization_path,str(i))
    os.makedirs(save_gt_path,exist_ok=True)
...
def save_scan(i, loglist, gt_class, gt_rel_cls, edge_indices, cls, rel_cls, top_k_obj, top_k_obj_2d, top_k_rel, top_k_rel_2d, tok_k_triplet, top_k_2d_triplet):
    ...
    save_prediction(i, cls, rel_cls)
    
def save_log(loglist, visualization_path="/media/michael/ssd1/SceneGraph/bfeat_neurips_viz"):
