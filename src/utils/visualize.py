...
def save_gt(i, gt_class, gt_rel_cls, edge_indices, visualization_path="/media/michael/ssd1/SceneGraph/bfeat_vl_sat_viz"):
...
def save_prediction(i, cls, rel_cls, obj_entropy, visualization_path="/media/michael/ssd1/SceneGraph/bfeat_vl_sat_viz"):
    save_gt_path=os.path.join(visualization_path,str(i))
    os.makedirs(save_gt_path,exist_ok=True)
...
def save_log(loglist, visualization_path="/media/michael/ssd1/SceneGraph/bfeat_vl_sat_viz"):
